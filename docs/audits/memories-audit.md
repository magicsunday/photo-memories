...
| Indexierung & Signalextraktion | gedeckt | Die Default-Media-Ingestion-Pipeline sequentiert MIME-Check, Zeit-/Geo-Normalisierung, Qualitäts-, Hash- und Duplikatstufen, schreibt anschließend eine typisierte `media_index.meta` über die neue Meta-Export-Stage und persistiert danach; `memories:index` bietet Force/Dry-Run/Video/Thumbnail-Optionen samt QA-Report-Ausgabe.【F:src/Service/Indexing/DefaultMediaIngestionPipeline.php†L32-L125】【F:src/Service/Indexing/Stage/MetaExportStage.php†L21-L224】【F:docs/media-index-meta-schema.md†L1-L63】【F:config/services.yaml†L390-L409】【F:src/Command/IndexCommand.php†L35-L170】 |
...
- Indexierung erfolgt unter `Service\Indexing` mit einer fest verdrahteten Stage-Pipeline inkl. Burst/Live-, Face- und Scene-Heuristiken, Hash-, Meta-Export- und Persistenzschritten.【F:config/services.yaml†L390-L409】
