...
| `memories:curate-vacation` | fehlt | Im Command-Verzeichnis existiert kein entsprechender Befehl; Vacation-Kuration erfolgt ausschließlich im Cluster-/Selektionslauf.【F:config/services.yaml†L1110-L1158】 |
...
- Ein dediziertes `memories:curate-vacation`-Kommando ist nicht vorhanden; Vacation-Kuration findet über Cluster-Strategien und Selektions-Profile statt.【F:config/services.yaml†L1110-L1158】
...
- Kein dediziertes `memories:curate-vacation`; Operator:innen müssen Cluster- und Feed-Kommandos manuell kombinieren.【F:config/services.yaml†L1110-L1158】
