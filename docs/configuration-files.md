...
- Das Highlights-Profil (`highlights`) reduziert die Kurationsmenge auf 30 Medien und verlangt mit `phash_min_hamming` = 20 einen größeren Abstand zwischen ähnlichen Motiven, damit wiederkehrende Szenen zuverlässiger gefiltert werden.
