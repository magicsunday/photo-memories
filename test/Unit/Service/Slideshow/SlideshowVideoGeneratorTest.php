...
final class SlideshowVideoGeneratorTest extends TestCase
{
    ...
    public function testTitleOverlayIsAppliedOnlyToFirstSlide(): void
    {
        ...
        self::assertStringContainsString('scale=1280:720:force_original_aspect_ratio=increase,zoompan=z=if(gte(iw/ih,1.778),1.05+(1.15-1.05)*min(PTS/3.75,1),1)', $filterComplex);
